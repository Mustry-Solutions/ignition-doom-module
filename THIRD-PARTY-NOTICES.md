...
|---|---|---|
| [Chocolate Doom](https://github.com/chocolate-doom/chocolate-doom) (Doom, Heretic and Hexen) | GPL-2.0 | compiled into `gateway/src/main/resources/mounted/{doom,heretic,hexen}/websockets-*.{js,wasm}`; `src/heretic/` and `src/hexen/` from upstream commit `749f4942` |
...
DOOM is a trademark of id Software LLC. Heretic and Hexen are trademarks of Raven Software / id Software. No Hexen game data is included.
